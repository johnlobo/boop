...
Hexadecimal [16-Bits]
                             ...
                             23 ;;  SDCC requires at least _DATA and _CODE areas to be declared, but you may use
                             24 ;;  any one of them for any purpose. Usually, compiler puts _DATA area contents
                             25 ;;  right after _CODE area contents.
                             26 ;;
                             27 .area _DATA
                             28 
                             29 
   8215 20 20 20 20 20 20    30 string_buffer:: .asciz "          "
        20 20 20 20 00
                             31 ;; Registros
                     ...
                     0007    36 V_SYNC       = 07
                             ...
                             38 
                             39 ;;
                             40 ;; Start of _CODE area
                             41 ;; 
                             42 .area _CODE
                             43 
                             44 ;;-----------------------------------------------------------------;; 
                             45 ;;  sys_util_h_times_e
                             46 ;;
                             47 ;; Inputs:
                             48 ;;   H and E
                             49 ;; Outputs:
                             50 ;;   HL is the product
                             51 ;;   D is 0
                             52 ;;   A,E,B,C are preserved
                             53 ;; 36 bytes
                             54 ;; min: 190cc
                             55 ;; max: 242cc
                             56 ;; avg: 216cc
                             ...
                             59 
   7980                      60 sys_util_h_times_e::
   7980 16 00         [ 7]   61   ld d,#0
   7982 6A            [ 4]   62   ld l,d
   7983 CB 24         [ 8]   63   sla h 
   7985 30 01         [12]   64   jr nc,.+3 
   7987 6B            [ 4]   65   ld l,e
   7988 29            [11]   66   add hl,hl 
   7989 30 01         [12]   67   jr nc,.+3 
   798B 19            [11]   68   add hl,de
   798C 29            [11]   69   add hl,hl 
   798D 30 01         [12]   70   jr nc,.+3 
   798F 19            [11]   71   add hl,de
   7990 29            [11]   72   add hl,hl 
   7991 30 01         [12]   73   jr nc,.+3 
   7993 19            [11]   74   add hl,de
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 101.
Hexadecimal [16-Bits]



   7994 29            [11]   75   add hl,hl 
   7995 30 01         [12]   76   jr nc,.+3 
   7997 19            [11]   77   add hl,de
   7998 29            [11]   78   add hl,hl 
   7999 30 01         [12]   79   jr nc,.+3 
   799B 19            [11]   80   add hl,de
   799C 29            [11]   81   add hl,hl 
   799D 30 01         [12]   82   jr nc,.+3 
   799F 19            [11]   83   add hl,de
   79A0 29            [11]   84   add hl,hl 
   79A1 D0            [11]   85   ret nc 
   79A2 19            [11]   86   add hl,de
   79A3 C9            [10]   87   ret
                             88 
                             89 ;;-----------------------------------------------------------------;; 
                             ...
                             91 ;;
                             92 ;;Inputs:
                             93 ;;     HL is the numerator
                             94 ;;     C is the denominator
                             95 ;;Outputs:
                             96 ;;     A is the remainder
                             97 ;;     B is 0
                             98 ;;     C is not changed
                             99 ;;     DE is not changed
                            100 ;;     HL is the quotient
                            101 ;;
   79A4                     102 sys_util_hl_div_c::
   79A4 06 10         [ 7]  103        ld b,#16
   79A6 AF            [ 4]  104        xor a
   79A7 29            [11]  105          add hl,hl
   79A8 17            [ 4]  106          rla
   79A9 B9            [ 4]  107          cp c
   79AA 38 02         [12]  108          jr c,.+4
   79AC 2C            [ 4]  109            inc l
   79AD 91            [ 4]  110            sub c
   79AE 10 F7         [13]  111          djnz .-7
   79B0 C9            [10]  112        ret
                            113 
                            114 ;;-----------------------------------------------------------------
                            115 ;;
                            116 ;; sys_util_BCD_GetEnd
                            117 ;;
                            118 ;;  
                            119 ;;  Input:  b: number of bytes of the bcd number
                            120 ;;          de: source for the first bcd bnumber
                            121 ;;          hl: source for the second bcd number
                            122 ;;  Output: 
                            123 ;;  Destroyed: af, bc,de, hl
                            124 ;;
                            125 ;;  Chibi Akumas BCD code (https://www.chibiakumas.com/z80/advanced.php#LessonA1)
                            126 ;;
   79B1                     127 sys_util_BCD_GetEnd::
...
Hexadecimal [16-Bits]
   ...
   79B1 C5            [11]  130 	push bc
   79B2 48            [ 4]  131 	ld c,b	;We want to add BC, but we need to add one less than the number of bytes
   79B3 0D            [ 4]  132 	dec c
   79B4 06 00         [ 7]  133 	ld b,#0
   79B6 09            [11]  134 	add hl,bc
   79B7 EB            [ 4]  135 	ex de, hl	;We've done HL, but we also want to do DE
   79B8 09            [11]  136 	add hl,bc
   79B9 EB            [ 4]  137 	ex de, hl
   79BA C1            [10]  138 	pop bc
   79BB C9            [10]  139 	ret
                            140 
                            141 ;;-----------------------------------------------------------------
                            142 ;;
                            143 ;; BCD_Add
                            144 ;;
                            145 ;;   Add two BCD numbers
                            146 ;;  Input:  hl: Number to add to de
                            147 ;;          de: Number to store the sum 
                            148 ;;  Output: 
                            149 ;;  Destroyed: af, bc,de, hl
                            150 ;;
                            151 ;;  Chibi Akumas BCD code (https://www.chibiakumas.com/z80/advanced.php#LessonA1)
                            152 ;;
   79BC                     153 sys_util_BCD_Add::
   79BC B7            [ 4]  154     or a
   79BD                     155 BCD_Add_Again:
   79BD 1A            [ 7]  156     ld a, (de)
   79BE 8E            [ 7]  157     adc (hl)
   79BF 27            [ 4]  158     daa
   79C0 12            [ 7]  159     ld (de), a
   79C1 13            [ 6]  160     inc de
   79C2 23            [ 6]  161     inc hl
   79C3 10 F8         [13]  162     djnz BCD_Add_Again
   79C5 C9            [10]  163     ret
                            164   
                            165 ;;-----------------------------------------------------------------
                            166 ;;
                            167 ;; sys_util_BCD_Compare
                            168 ;;
                            169 ;;  Compare two BCD numbers
                            170 ;;  Input:  hl: BCD Number 1
                            171 ;;          de: BCD Number 2
                            172 ;;  Output: 
                            173 ;;  Destroyed: af, bc,de, hl
                            174 ;;
                            175 ;;  Chibi Akumas BCD code (https://www.chibiakumas.com/z80/advanced.php#LessonA1)
                            176 ;;
   79C6                     177 sys_util_BCD_Compare::
   79C6 06 04         [ 7]  178   ld b, #SCORE_NUM_BYTES
   79C8 CD B1 79      [17]  179   call sys_util_BCD_GetEnd
   79CB                     180 BCD_cp_direct:
   79CB 1A            [ 7]  181   ld a, (de)
   79CC BE            [ 7]  182   cp (hl)
   79CD D8            [11]  183   ret c
   79CE C0            [11]  184   ret nz
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 103.
Hexadecimal [16-Bits]



   79CF 1B            [ 6]  185   dec de
   79D0 2B            [ 6]  186   dec hl
   79D1 10 F8         [13]  187   djnz BCD_cp_direct
   79D3 B7            [ 4]  188   or a                    ;; Clear carry
   79D4 C9            [10]  189   ret
                            190 
                            191 ;;-----------------------------------------------------------------
                            192 ;;
                            193 ;; sys_util_get_random_number
                            194 ;;
                            195 ;;  Returns a random number between 0 and <end>
                            196 ;;  Input:  a: <end>
   ...
   79D9 CD 21 81      [17]  203   call cpct_getRandom_mxor_u8_asm
   ...
   79DF 0E 00         [ 7]  207   ld c, #0                            ;; Load c with the max number
   79E1 06 00         [ 7]  208   ld b, #0
   79E3                     209 _random_mod_loop:
   79E3 B7            [ 4]  210   or a                                ;; reset carry
   79E4 ED 42         [15]  211   sbc hl,bc                           ;; hl = hl - bc
   79E6 F2 E3 79      [10]  212   jp p, _random_mod_loop              ;; Jump back if hl > 0
   79E9 09            [11]  213   add hl,bc                           ;; Adds max number to hl back to get back to positive values
   79EA 7D            [ 4]  214   ld a,l                              ;; loads the normalized random number in a
   79EB C9            [10]  215 ret
                            216 
                            217 ;;-----------------------------------------------------------------
                            218 ;;
                            219 ;; sys_util_delay
                            220 ;;
                            221 ;;  Waits a determined number of frames 
                            222 ;;  Input:  b: number of frames
                            223 ;;  Output: 
                            224 ;;  Destroyed: af, bc
                            225 ;;
   79EC                     226 sys_util_delay::
   79EC C5            [11]  227   push bc
   79ED CD 69 81      [17]  228   call cpct_waitVSYNCStart_asm
...
Hexadecimal [16-Bits]
                            ...
                            240 ;;  Destroyed: 
                            241 ;;
   79F4                     242 CRTC_V_auto:
   79F4 01 06 BC      [10]  243 	ld bc, #0xBC00 + V_LINES
   79F7 ED 49         [12]  244 	out (c), c
   79F9 21 00 BD      [10]  245 	ld hl, #0xBD00
   79FC 19            [11]  246 	add hl, de
   79FD 44            [ 4]  247 	ld b, h
   79FE 4D            [ 4]  248 	ld c, l
   79FF ED 49         [12]  249 	out (c), c
   7A01 C9            [10]  250 	ret
                            251 
                            252 ;;-----------------------------------------------------------------
                            253 ;;
                            ...
                            259 ;;  Destroyed: 
                            260 ;;
   7A02                     261 CRTC_H_auto:
   7A02 01 02 BC      [10]  262 	ld bc, #0xBC00 + H_ADJUST
   7A05 ED 49         [12]  263 	out (c), c
   7A07 21 00 BD      [10]  264 	ld hl, #0xBD00
   7A0A 19            [11]  265 	add hl, de
   7A0B 44            [ 4]  266 	ld b, h
   7A0C 4D            [ 4]  267 	ld c, l
   7A0D ED 49         [12]  268 	out (c), c
   7A0F C9            [10]  269 	ret
                            270 
                            271 ;;-----------------------------------------------------------------
                            272 ;;
                            273 ;; sys_util_fadeOut
                            274 ;;
                            275 ;;  
                            276 ;;  Input:  
                            277 ;;  Output: 
                            278 ;;  Destroyed: 
                            279 ;;
   7A10                     280 sys_util_fadeOut::
   7A10 11 19 00      [10]  281 	ld de, #25
   7A13                     282 height_out:
   7A13 3E 0C         [ 7]  283     ld a, #12
   7A15 CD 53 7A      [17]  284 	call crt_delay
   7A18 CD F4 79      [17]  285 	call CRTC_V_auto
   7A1B 1D            [ 4]  286 	dec e
   7A1C C2 13 7A      [10]  287 	jp nz, height_out
   7A1F CD F4 79      [17]  288 	call CRTC_V_auto
   7A22 C9            [10]  289 	ret
                            290 
                            291 ;;-----------------------------------------------------------------
                            292 ;;
...
Hexadecimal [16-Bits]
                            ...
                            298 ;;  Destroyed: 
                            299 ;;
   7A23                     300 sys_util_fadeIn::
   7A23 11 00 00      [10]  301 	ld de, #0
   7A26                     302 height_in:
   7A26 3E 0C         [ 7]  303     ld a, #12
   7A28 CD 53 7A      [17]  304 	call crt_delay 
   7A2B CD F4 79      [17]  305 	call CRTC_V_auto
   7A2E 1C            [ 4]  306 	inc e
   7A2F 7B            [ 4]  307 	ld a, e
   7A30 FE 1A         [ 7]  308 	cp #26
   7A32 C2 26 7A      [10]  309 	jp nz, height_in
   7A35 C9            [10]  310 	ret
                            311 
                            312 ;;-----------------------------------------------------------------
                            313 ;;
                            314 ;; sys_util_temblor
                            315 ;;
                            316 ;;  
                            317 ;;  Input:  
                            318 ;;  Output: 
                            319 ;;  Destroyed: 
                            320 ;;
   7A36                     321 sys_util_temblor::
   7A36 11 2F 00      [10]  322 	ld de, #47
   7A39 CD 02 7A      [17]  323 	call CRTC_H_auto
   7A3C 11 2D 00      [10]  324 	ld de, #45
   7A3F 3E 09         [ 7]  325     ld a, #9
   7A41 CD 53 7A      [17]  326 	call crt_delay
   7A44 CD 02 7A      [17]  327 	call CRTC_H_auto
   7A47 11 2E 00      [10]  328 	ld de, #46
   7A4A 3E 09         [ 7]  329     ld a, #9
   7A4C CD 53 7A      [17]  330 	call crt_delay 
   7A4F CD 02 7A      [17]  331 	call CRTC_H_auto
   7A52 C9            [10]  332 	ret
                            333 
                            334 ;;-----------------------------------------------------------------
                            335 ;;
   ...
   7A53 76            [ 4]  344 	halt
   7A54 3D            [ 4]  345 	dec a
   7A55 20 FC         [12]  346 	jr nz, crt_delay
   7A57 C9            [10]  347 	ret
                            348 
...
Hexadecimal [16-Bits]
                            ...
                            350 ;
                            351 ; Description: Counts the number of '1' bits in an 8-bit binary number.
                            352 ;
                            353 ; Input:
                            354 ;   Register A: The 8-bit number to be analyzed.
                            355 ;
                            356 ; Output:
                            357 ;   Register B: Contains the count of '1's found in the input number.
                            358 ;
                            359 ; Affected Registers:
                            360 ;   A, B, C, F (Flags)
                            361 
   7A58                     362 sys_util_count_set_bits::
   7A58 A8            [ 4]  363     XOR B           ; Initialize '1's counter (register B) to zero.
   7A59 0E 08         [ 7]  364     LD C, #8         ; Initialize bit counter (register C) to 8 (for 8 bits).
                            365 
   7A5B                     366 BIT_LOOP:
   7A5B 17            [ 4]  367     RLA             ; Rotate Accumulator A left. The Most Significant Bit (MSB)
                            368                     ; moves into the Carry Flag (CF). The previous CF moves into the Least Significant Bit (LSB).
   7A5C 30 01         [12]  369     JR NC, NEXT_BIT ; If Carry Flag is CLEAR (the bit was 0), jump to NEXT_BIT.
   7A5E 04            [ 4]  370     INC B           ; If Carry Flag is SET (the bit was 1), increment the '1's counter.
                            371 
   7A5F                     372 NEXT_BIT:
   7A5F 0D            [ 4]  373     DEC C           ; Decrement the bit counter.
   7A60 20 F9         [12]  374     JR NZ, BIT_LOOP ; If C is not zero, more bits to check, loop again.
                            375 
   7A62 C9            [10]  376     RET             ; Return from the routine. The result is in B.
                            377 
                            378 ;;-----------------------------------------------------------------
                            379 ;;
                            380 ;; crt_delay
                            381 ;;
                            382 ;;  
                            383 ;;  Input: El valor a modificar está en el registro A
                            384 ;;  Output: El registro A con su magnitud reducida en 1
                            385 ;;  Destroyed: 
                            386 ;;
   7A63                     387 sys_utiL_reduce_a:
   7A63 B7            [ 4]  388   or a            ; 1. Actualiza las banderas (S y Z) sin cambiar el valor de A.
   7A64 C8            [11]  389   ret z           ; 2. Si es CERO (Flag Z=1), no hacemos nada. Saltamos al final.
   7A65 FA 6A 7A      [10]  390   jp M, es_neg    ; 3. Si es NEGATIVO (Flag S=1/Minus), saltamos a sumar.
                            391 ; --- Caso Positivo ---
   7A68 3D            [ 4]  392   dec a           ; Si es positivo (ej: 5), restamos 1 (queda 4).
   7A69 C9            [10]  393   ret             ; Retornamos para no ejecutar la parte negativa.
   7A6A                     394 es_neg:
                            395 ; --- Caso Negativo ---
   7A6A 3C            [ 4]  396   inc A           ; Si es negativo (ej: -5), sumamos 1 (queda -4).
