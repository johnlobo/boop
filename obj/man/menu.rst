...
Hexadecimal [16-Bits]
                             ...
                             29 .area _DATA
                             30 
   88EA 4F 4E 45 20 50 4C    31 _menu_opt1_string:  .asciz "ONE PLAYER"
        41 59 45 52 00
   88F5 54 57 4F 20 50 4C    32 _menu_opt2_string:  .asciz "TWO PLAYERS"
        41 59 45 52 53 00
   8901 48 45 4C 50 00       33 _menu_opt3_string:  .asciz "HELP"
                             34 
   8906 00                   35 man_menu_selected::  .db 0      ;; 0 = ONE PLAYER, 1 = TWO PLAYERS, 2 = HELP
   8907 00                   36 man_menu_confirmed:: .db 0      ;; 0 = not confirmed, 1 = ONE PLAYER, 2 = TWO PLAYERS, 3 = HELP
                             37 
   8908 00                   38 _menu_key_debounce: .db 0       ;; 1 if a key was held last frame
                             39 
                             40 ;;
                             ...
                             47 ;; man_menu_draw
                             48 ;;
                             49 ;;  Draws both menu options. Selected option in yellow, other in white.
                             50 ;;  Input:
                             51 ;;  Output:
                             52 ;;  Modified: AF, BC, DE, HL
                             53 ;;
   82F0                      54 man_menu_draw::
   ...
   82F0 11 8F D3      [10]    1    ld DE, #CPCT_VMEM_START_ASM + 80 * (90 / 8) + 2048 * (90 & 7) + 31   ;; [3] REG16 = screenPtr
   82F3 21 EA 88      [10]   57    ld hl, #_menu_opt1_string
   82F6 3A 06 89      [13]   58    ld a, (man_menu_selected)
   82F9 B7            [ 4]   59    or a
   82FA 20 04         [12]   60    jr nz, _draw_opt1_white
   82FC 0E 01         [ 7]   61    ld c, #1                          ;; Bright Yellow = selected
   82FE 18 02         [12]   62    jr _draw_opt1
   8300                      63 _draw_opt1_white:
   8300 0E 00         [ 7]   64    ld c, #0                          ;; Bright White = unselected
   8302                      65 _draw_opt1:
   8302 CD B5 78      [17]   66    call sys_text_draw_string
                             67 
   ...
   8305 11 2E F4      [10]    1    ld DE, #CPCT_VMEM_START_ASM + 80 * (110 / 8) + 2048 * (110 & 7) + 30   ;; [3] REG16 = screenPtr
   8308 21 F5 88      [10]   70    ld hl, #_menu_opt2_string
   830B 3A 06 89      [13]   71    ld a, (man_menu_selected)
   830E FE 01         [ 7]   72    cp #1
   8310 20 04         [12]   73    jr nz, _draw_opt2_white
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 105.
Hexadecimal [16-Bits]



   8312 0E 01         [ 7]   74    ld c, #1                          ;; Bright Yellow = selected
   8314 18 02         [12]   75    jr _draw_opt2
   8316                      76 _draw_opt2_white:
   8316 0E 00         [ 7]   77    ld c, #0                          ;; Bright White = unselected
   8318                      78 _draw_opt2:
   8318 CD B5 78      [17]   79    call sys_text_draw_string
                             80 
   ...
   831B 11 22 D5      [10]    1    ld DE, #CPCT_VMEM_START_ASM + 80 * (130 / 8) + 2048 * (130 & 7) + 34   ;; [3] REG16 = screenPtr
   831E 21 01 89      [10]   83    ld hl, #_menu_opt3_string
   8321 3A 06 89      [13]   84    ld a, (man_menu_selected)
   8324 FE 02         [ 7]   85    cp #2
   8326 20 04         [12]   86    jr nz, _draw_opt3_white
   8328 0E 01         [ 7]   87    ld c, #1                          ;; Bright Yellow = selected
   832A 18 02         [12]   88    jr _draw_opt3
   832C                      89 _draw_opt3_white:
   832C 0E 00         [ 7]   90    ld c, #0                          ;; Bright White = unselected
   832E                      91 _draw_opt3:
   832E CD B5 78      [17]   92    call sys_text_draw_string
                             93 
                             94 
   8331 C9            [10]   95    ret
                             96 
                             ...
                             99 ;; man_menu_init
                            100 ;;
                            101 ;;  Initializes and draws the main menu
                            102 ;;  Input:
                            103 ;;  Output:
                            104 ;;  Modified: AF, BC, DE, HL
                            105 ;;
   8332                     106 man_menu_init::
   8332 AF            [ 4]  107    xor a
   8333 32 06 89      [13]  108    ld (man_menu_selected), a
   8336 32 07 89      [13]  109    ld (man_menu_confirmed), a
   8339 32 08 89      [13]  110    ld (_menu_key_debounce), a
                            111 
   833C CD 6A 76      [17]  112    call sys_render_clear_buffer
   833F CD F0 82      [17]  113    call man_menu_draw
                            114 
   8342 C9            [10]  115    ret
                            116 
                            117 ;;-----------------------------------------------------------------
                            ...
                            119 ;; man_menu_update
                            120 ;;
                            121 ;;  Updates the main menu each frame: cursor navigation and confirm.
                            122 ;;  Input:
                            123 ;;  Output:
                            124 ;;  Modified: AF, BC, DE, HL
                            125 ;;
   8343                     126 man_menu_update::
...
Hexadecimal [16-Bits]
   ...
   8343 3A 08 89      [13]  128    ld a, (_menu_key_debounce)
   8346 B7            [ 4]  129    or a
   8347 28 0A         [12]  130    jr z, _mmu_check_keys
   8349 CD D4 84      [17]  131    call cpct_isAnyKeyPressed_asm
   834C B7            [ 4]  132    or a
   834D C0            [11]  133    ret nz                            ;; still held, do nothing this frame
   834E AF            [ 4]  134    xor a
   834F 32 08 89      [13]  135    ld (_menu_key_debounce), a
   8352 C9            [10]  136    ret
                            137 
   8353                     138 _mmu_check_keys:
                            139    ;; Cursor Up: move selection up, wrapping 0 -> 2
   8353 21 00 01      [10]  140    ld hl, #Key_CursorUp
   8356 CD FA 83      [17]  141    call cpct_isKeyPressed_asm
   8359 28 13         [12]  142    jr z, _mmu_check_down
   835B 3A 06 89      [13]  143    ld a, (man_menu_selected)
   835E B7            [ 4]  144    or a
   835F 28 03         [12]  145    jr z, _mmu_up_wrap
   8361 3D            [ 4]  146    dec a
   8362 18 02         [12]  147    jr _mmu_up_done
   8364                     148 _mmu_up_wrap:
   8364 3E 02         [ 7]  149    ld a, #2
   8366                     150 _mmu_up_done:
   8366 32 06 89      [13]  151    ld (man_menu_selected), a
   8369 CD F0 82      [17]  152    call man_menu_draw
   836C 18 2A         [12]  153    jr _mmu_set_debounce
                            154 
   836E                     155 _mmu_check_down:
                            156    ;; Cursor Down: move selection down, wrapping 2 -> 0
   836E 21 00 04      [10]  157    ld hl, #Key_CursorDown
   8371 CD FA 83      [17]  158    call cpct_isKeyPressed_asm
   8374 28 13         [12]  159    jr z, _mmu_check_enter
   8376 3A 06 89      [13]  160    ld a, (man_menu_selected)
   8379 FE 02         [ 7]  161    cp #2
   837B 28 03         [12]  162    jr z, _mmu_down_wrap
   837D 3C            [ 4]  163    inc a
   837E 18 01         [12]  164    jr _mmu_down_done
   8380                     165 _mmu_down_wrap:
   8380 AF            [ 4]  166    xor a
   8381                     167 _mmu_down_done:
   8381 32 06 89      [13]  168    ld (man_menu_selected), a
   8384 CD F0 82      [17]  169    call man_menu_draw
   8387 18 0F         [12]  170    jr _mmu_set_debounce
                            171 
   8389                     172 _mmu_check_enter:
                            173    ;; Enter: confirm current selection
   8389 21 02 04      [10]  174    ld hl, #Key_Return
   838C CD FA 83      [17]  175    call cpct_isKeyPressed_asm
   838F 28 0C         [12]  176    jr z, _mmu_done
   8391 3A 06 89      [13]  177    ld a, (man_menu_selected)
   8394 3C            [ 4]  178    inc a                             ;; 1 = ONE PLAYER, 2 = TWO PLAYERS
   8395 32 07 89      [13]  179    ld (man_menu_confirmed), a
                            180 
   8398                     181 _mmu_set_debounce:
   8398 3E 01         [ 7]  182    ld a, #1
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 107.
Hexadecimal [16-Bits]



   839A 32 08 89      [13]  183    ld (_menu_key_debounce), a
                            184 
   839D                     185 _mmu_done:
   839D C9            [10]  186    ret
