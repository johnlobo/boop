...
## Pen → colour name (CPC firmware colour index in parentheses)
##  0=Black(0)        1=White(13)       2=Bright Blue(2)   3=Red(3)
##  4=Bright Red(6)   5=Orange(15)      6=Pastel Green(24) 7=Yellow(12)
##  8=Pink(16)        9=Green(9)       10=Cyan(10)        11=Pastel Blue(14)
## 12=Bright Cyan(11) 13=Bright Green(20) 14=Blue(1)      15=Bright White(26)
...
$(eval $(call IMG2SP, CONVERT         , assets/sprites/gatito-walking.png , 10, 14, s_gatito_walking, ,))
$(eval $(call IMG2SP, CONVERT         , assets/sprites/gatito_blue.png , 10, 14, s_gatito_blue, ,))
$(eval $(call IMG2SP, CONVERT         , assets/sprites/gatito_orange.png , 10, 14, s_gatito_orange, ,))
$(eval $(call IMG2SP, CONVERT         , assets/sprites/gato_blue.png , 10, 17, s_gato_blue, ,))
$(eval $(call IMG2SP, CONVERT         , assets/sprites/gato_orange.png , 10, 17, s_gato_orange, ,))
$(eval $(call IMG2SP, CONVERT         , assets/sprites/cat.png , 10, 17, s_cat, ,))
$(eval $(call IMG2SP, CONVERT         , assets/sprites/catty.png , 10, 17, s_catty, ,))
$(eval $(call IMG2SP, CONVERT         , assets/sprites/big_numbers.png , 6, 13, s_big_numbers, ,))
$(eval $(call IMG2SP, CONVERT         , assets/sprites/basket.png , 38, 74, s_basket, ,))
$(eval $(call IMG2SP, SET_FOLDER      , src/assets/bg               ))
$(eval $(call IMG2SP, CONVERT         , assets/bg/header.png , 56, 16, bg_header, ,))
$(eval $(call IMG2SP, CONVERT         , assets/bg/grid.png , 88, 148, bg_grid, ,))
